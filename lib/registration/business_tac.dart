...
class BusinessTac extends StatefulWidget {
  const BusinessTac({super.key});

  @override
  _BusinessTacState createState() => _BusinessTacState();
}

class _BusinessTacState extends State<BusinessTac> {
              ...
              child: ElevatedButton(
                onPressed: isAccepted
                  ...
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (_) => const BusinessRegistration(),
                    ),
                  );
                }
                    : null,
